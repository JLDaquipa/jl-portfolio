        ...
        <div className='box-row lg:flex-row gap-3'>
          ...
          <div className='flex gap-3 justify-center'>
            <div className='bento-box flex-1 justify-center lg:w-fit'>
              <a className='flex gap-2 font-semibold items-center' href="https://github.com/JLDaquipa/nike-landing-page.git" target='_blank' rel="noreferrer">
                <img src={mergeIcon} alt="" />
                Repo
              </a>
            </div>
            <div className='bento-box flex-1 justify-center lg:w-fit'>
              <a className='flex gap-3 font-semibold items-center ' href="https://nike-new-arrivals-page-23.netlify.app/" target='_blank' rel="noreferrer">
                <img src={globe} alt="" />
                Live
              </a>
            </div>
