...
import { weblog_ss1 } from "../../assets/works";
import mergeIcon from '../../assets/icons/git-merge.svg';
import globe from '../../assets/icons/globe.svg';

const Work5 = ({toggleClose}) => {
  return (
      ...
      <div className='overflow-y-auto hide-scrollbar flex flex-col gap-3'>
        ...
        <div className='box-row lg:flex-row gap-3'>
          <div className='bento-box justify-center flex-1'>
            <h3 className='text-3xl text-white'>WeBlog</h3>
          </div>
          <div className='flex gap-3 justify-center'>
            <div className='bento-box flex-1 justify-center lg:w-fit'>
              <a className='flex gap-2 font-semibold items-center' href="https://github.com/JLDaquipa/Refocus-Project-AdaptiveBlog.git" target='_blank' rel="noreferrer">
                <img src={mergeIcon} alt="" />
                Repo
              </a>
            </div>
            <div className='bento-box flex-1 justify-center lg:w-fit'>
              <a className='flex gap-3 font-semibold items-center ' href="https://jl-daquipa-weblog.netlify.app/" target='_blank' rel="noreferrer">
                <img src={globe} alt="" />
                Live
              </a>
            </div>
          ...
          <div className='bento-box flex-col gap-12 pb-20 lg:pb-40'>
            <div className='description-row1 flex max-lg:flex-col max-lg:gap-12 gap-20 lg:flex-1'>
              <div className='flex flex-col gap-4 flex-1'>
                ...
                <p className='font-medium'>WeBlog is a web application where you can view, add, like, and comment on a list of blogs.</p>
              </div>
            ...
            <div className='description-row2 flex lg:flex-1'>
              <div className='flex flex-col gap-8'>
                ...
                <p className='font-medium'>“Prop drilling” is a concept that a developer should avoid using in building their website in ReactJS so my purpose in building this website is to train myself using React Context and also to get more familiar with React Router.</p>
              </div>
            </div>
          </div>
        </div>
