...
const Hero = () => {
  ...
  return (
    <section className="section">
      ...
      <div className='box-row flex-col w-full'>
        {/* Socials Links */}
        <div className='bento-row flex gap-3'>
          <div className='social flex-1 justify-center'>
            <a className='group flex justify-center gap-4 items-center border border-opacity-80 rounded-2xl border-outline-gray px-6 py-4 bg-light-black' href="https://www.facebook.com/jaylloyd.daquipa/" target='_blank' rel="noreferrer">
              <svg className="fill-slate-gray cursor-pointer group-hover:fill-primary-orange smooth-transition" xmlns="http://www.w3.org/2000/svg" width="12" height="20" viewBox="0 0 17 32" fill="none">
              ...
              <span className='font-semibold max-md:hidden'>Facebook</span>
            </a>
          </div>
          {/* Github */}
          <div className='social flex-1 justify-center'>
            <a className='group flex justify-center gap-4 items-center border border-opacity-80 rounded-2xl border-outline-gray px-6 py-4 bg-light-black' href="https://github.com/JLDaquipa" target='_blank' rel="noreferrer">
              <svg className="fill-slate-gray cursor-pointer group-hover:fill-primary-orange smooth-transition" xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 34 34" fill="none">
              ...
              <span className='font-semibold max-md:hidden'>Github</span>
            </a>
          </div>
          {/* LinkedIn */}
          <div className='social flex-1 justify-center'>
            <a className='group flex justify-center gap-4 items-center border border-opacity-80 rounded-2xl border-outline-gray px-6 py-4 bg-light-black' href="https://www.linkedin.com/in/jay-lloyd-daquipa-619787296" target='_blank' rel="noreferrer">
              <svg className="fill-slate-gray cursor-pointer group-hover:fill-primary-orange smooth-transition" xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 33 32" fill="none">
              ...
              <span className='font-semibold max-md:hidden'>LinkedIn</span>
            </a>
          </div>
        </div>
      </div>
